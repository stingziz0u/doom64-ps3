...
char *sprnames[NUMSPRITES] = { // 8005EE30
	"SPOT", "PLAY", "SARG", "FATT", "POSS", "TROO", "HEAD", "BOSS", "SKUL",
	"BSPI", "CYBR", "PAIN", "RECT", "MISL", "PLSS", "BFS1", "LASS", "BAL1",
	"BAL3", "BAL2", "BAL7", "BAL8", "APLS", "MANF", "TRCR", "DART", "FIRE",
	"RBAL", "PUF2", "PUF3", "PUFF", "BLUD", "A027", "TFOG", "BFE2", "ARM1",
	"ARM2", "BON1", "BON2", "BKEY", "RKEY", "YKEY", "YSKU", "RSKU", "BSKU",
	"ART1", "ART2", "ART3", "STIM", "MEDI", "SOUL", "PINV", "PSTR", "PINS",
	"SUIT", "PMAP", "PVIS", "MEGA", "CLIP", "AMMO", "RCKT", "BROK", "CELL",
	"CELP", "SHEL", "SBOX", "BPAK", "BFUG", "CSAW", "MGUN", "LAUN", "PLSM",
	"SHOT", "SGN2", "LSRG", "CAND", "BAR1", "LMP1", "LMP2", "A031", "A030",
	"A032", "A033", "A034", "BFLM", "RFLM", "YFLM", "A006", "A021", "A003",
	"A020", "A014", "A016", "A008", "A007", "A015", "A001", "A012", "A010",
	"A018", "A017", "A026", "A022", "A028", "A029", "A035", "A036", "TRE3",
	"TRE2", "TRE1", "A013", "A019", "A004", "A005", "A023", "SAWG", "PUNG",
	"PISG", "SHT1", "SHT2", "CHGG", "ROCK", "PLAS", "BFGG", "LASR"
};
...
state_t states[NUMSTATES] = // 8004D3F4
	{
		...
		{ SPR_PLAS, 0, 1, A_PlasmaReady, S_771 }, /*S_771*/
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = // 80051238
	{ {
		  ...
		  MF_SOLID | MF_SHOOTABLE | MF_GRAVITY | MF_DROPOFF |
			  MF_PICKUP | MF_NOTDMATCH, /* flags */
		  0, /* palette */
		  255, /* alpha */
	  },

	  {
		  ...
		  sfx_None, /* activesound */
		  MF_SOLID | MF_SHOOTABLE | MF_GRAVITY | MF_DROPOFF |
			  MF_COUNTKILL | MF_NOTDMATCH, /* flags */
		  1, /* palette */
		  255, /* alpha */
	  },
...

	  {
		  ...
		  MF_SOLID | MF_SHOOTABLE | MF_GRAVITY |
			  MF_COUNTKILL, /* flags */
		  0, /* palette */
		  255, /* alpha */
	  },
...

	  {
		  ...
		  0, /* damage */
		  sfx_impact, /* activesound */
		  MF_SOLID | MF_SHOOTABLE | MF_GRAVITY | MF_COUNTKILL |
			  MF_SHADOW, /* flags */
		  1, /* palette */
		  180, /* alpha */
	  },
...

	  {
		  ...
		  5, /* damage */
		  sfx_None, /* activesound */
		  MF_NOBLOCKMAP | MF_GRAVITY | MF_DROPOFF | MF_MISSILE |
			  MF_SHADOW, /* flags */
		  0, /* palette */
		  180, /* alpha */
	  },
