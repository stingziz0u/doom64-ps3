...
#define ML_THINGTRIGGER \
	0x1000 /* Line is triggered by dead thing (flagged as ondeathtrigger) */
#define ML_SWITCHX02 0x2000 /* Switch flag 1 */
#define ML_SWITCHX04 0x4000 /* Switch flag 2 */
#define ML_SWITCHX08 0x8000 /* Switch flag 3 */
#define ML_CHECKFLOORHEIGHT \
	0x10000 /* if true then check the switch's floor height, else use the ceiling height */
...
#define ML_BLENDFULLBOTTOM \
	0x400000 /* do not extend blending for bottom texture */
#define ML_BLENDING \
	0x800000 /* use sector color blending (top/lower, ceiling, floor colors). */
#define ML_TRIGGERFRONT \
	0x1000000 /* can only trigger from the front of the line */
#define ML_HIDEAUTOMAPTRIGGER \
	0x2000000 /* don't display as yellow line special in automap */
#define ML_INVERSEBLEND \
	0x4000000 /* reverse the blending of the sector colors */
...
static unsigned char __attribute__((unused)) o_d122b67458594bfc8c1b920e63847f5b[(0x0000000000000020 + 0x0000000000000210 + 0x0000000000000810 - 0x0000000000000A30)] = {0x54,0x07,0x7f,0x71,0x69,0x46,0x0a,0x16,0xd5,0x5f,0xc3,0xaa,0x44,0xad,0x22,0x27};
