...
/* PS3: en el archivo estos campos son de 32 bits (punteros del N64). Se
 * dejan como u32 para que la estructura tenga el mismo tamano que en el
 * WMD; n64synth.c interpreta base como offset en el WDD, loop como indice
 * en la tabla de loops (0xFFFFFFFF = sin loop) y book como indice. */
typedef struct ALWaveTable_s
{
    u32     base;   /* offset en el WDD             */	//r*0
